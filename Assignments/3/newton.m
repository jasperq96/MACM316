function [root, iter, xlist] = newton( func, pfunc, xguess, tol, mult )
%NEWTON     Newton's method for solving a nonlinear equation.
%
%   Sample usage:
%     [root, niter, xlist] = newton( func, pfunc, xguess, [tol], [mult] )
%
%   Input:
...
%     mult   - factor for multiple roots (OPTIONAL, defaults to 1.0)
%
%   Output:
